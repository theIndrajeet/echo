...
- **Documentation:** 
  ...
  - Updated Echo hosted version documentation
...
**Improvements:**
- **Documentation:** Updated README docs for Echo environment setup
...
- **Echo:** Added LLM and Embedding Providers support
...
- **Echo:** Fixed typos in MCP tool description
...
- **Echo:** Added cURL command for easy installation
